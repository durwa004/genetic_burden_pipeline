...
if __name__ == '__main__':
    ...
    for i in tmp:
        ...
        with open(pbs, "w") as f:
            print(header, file=f)
            print(f"cd {data}\n", file=f)
            print(f"perl {annovar_v}convert2annovar.pl -format vcf4 -allsample -include -withfreq " + i + ".vcf.gz --out annovar/" + i + "_annovar_intersect.avinput\n"
